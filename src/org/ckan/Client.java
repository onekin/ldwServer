...
public final class Client
{
    ...
    */
    ...
    {
    	String XXXX =postAndReturnTheJSON("/api/action/package_create",getJsonFromGsonObject(dataset));
        DatasetResult dr = getGsonObjectFromJson(DatasetResult.class,XXXX,"createDataset");
        return dr.result;
    }
    ...
    {
    	String XXXX =postAndReturnTheJSON("/api/action/package_update",getJsonFromGsonObject(ds));
        return getGsonObjectFromJson(DatasetResult.class,XXXX,"updateDataset");
    }

    public DatasetResult updateDataset99(Dataset ds) throws CKANException
    {
